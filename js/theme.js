...
form.on('submit', function (e) {
	...
	grecaptcha.ready(function() {
      grecaptcha.execute('6LdPd58nAAAAAIPAyzvoPbGnqUPyvhOrCU-nztT4', {action: 'submit'}).then(function(token) {
          $.ajax({
			url: 'email.php', // form action url
			...
			beforeSend: function () {
				...
				var loadingText = '<span role="status" aria-hidden="true" class="spinner-border spinner-border-sm align-self-center me-2"></span>Enviando...';
			...
			success: function (data) {
				$('.message-response').text(data.Message).fadeIn("slow");
